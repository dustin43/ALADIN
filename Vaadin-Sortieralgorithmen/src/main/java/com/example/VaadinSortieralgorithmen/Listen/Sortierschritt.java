package com.example.VaadinSortieralgorithmen.Listen;
...
public class Sortierschritt {
    ...
    public String getSortierfeld_String() {
        int index_element = 0;
        StringBuilder stringBuilder = new StringBuilder();
        for (String element : this.sortierfeld) {
            stringBuilder.append("[").append(index_element).append("] ").append(element).append(";\t");
            index_element++;
        }
