...
public class Printer {
    ...
    // Output: z.B.
    //  - Aktueller Zustand:	[0] 13; [1] 53; [2] 61; [3] 8; [4] 48; 	||	Getauschte Felder: [0] 53, [1] 13
    public void print_schritt(Sortierschritt schritt) {
        // Index der einzelnen Elemente
        int index_element = 0;
        System.out.print("Aktueller Zustand:\t");
        ...
        System.out.print("\t||\tGetauschte Felder: [" + schritt.getIndex_element1() + "] " + schritt.getElement1() + ", [" + schritt.getIndex_element2() + "] " + schritt.getElement2());
        System.out.println();
    }
